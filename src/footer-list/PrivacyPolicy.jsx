...
const PrivacyPolicy = () => {
  return (
    <>
      <div className="pp-main w-full sm:pb-20 sm:pt-40 pb-[10%] pt-36 md:px-[20px] lg:px-[150px] sm:px-[150px] px-5 bg-gradient-to-t from-[#d5e8fe] to-[#7CADF0]">
        <div className="part-1 mb-16">
          <p className="font-semibold text-3xl mb-5">GrowSharp Privacy Policy</p>
          <p>
            At GrowSharp, we are committed to protecting the privacy and
