...
const Footer = () => {
  return (
    <>
      <div className=" bg-gradient-to-t from-[#d0f4ff] to-[#fff]  pt-9">
        <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
          <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
            <div className="md:w-[316px]">
              <p className="text-[18px] font-medium text-black">
                <h1 className="text-black font-extrabold">
                  <span className="text-rose-600">Grow</span>Sharp
                </h1>
              </p>
              {/* <img
              ...
              <div className="mt-[23px] flex">
                ...
                <div className="ml-[18px]">
                  <a
                    ...
                    className="font-Inter text-[14px] font-medium text-[#000]"
                  >
                    help@lorem.com
                  </a>
                  <p className="font-Inter text-[12px] font-medium text-[#000]">
                    Support Email
                  </p>
                </div>
              </div>
