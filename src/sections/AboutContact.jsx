...
function AboutContact() {
  return (
    <>
      <div className="main-contact-div sm:w-full w-[95%] md:w-full md:px-0 m-auto sm:pb-20 sm:pt-44 xl:pt-12 pt-[10%] sm:px-[120px] lg:px-[120px] xl:px-[120px]  ">
      {/* <ContactUs /> */}
        <section
          className="bg-white dark:bg-[#fff] rounded-[10px] "
          style={{ boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}
        >
          <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-gray-700">
              Contact Us
            </h2>
            <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
              To know more details or further quaries please fill this from
            </p>
            <form className="space-y-8">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Leave a Quary or Problems..."
                ></textarea>
              </div>
              <button
                type="submit"
                className="py-3 px-5  text-sm font-semibold text-center bg-[#FFAD17] text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
                Send message
              </button>
            </form>
